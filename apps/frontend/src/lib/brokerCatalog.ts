  ...
  mt4: {
    ...
    credentials: [
      ...
      credential(
        ...
        'Connection Mode',
        '',
        'Bridge removes MetaApi dependency (requires your MT bridge node).',
        {
          type: 'select',
          options: [
            { label: 'Bridge (self-hosted)', value: 'bridge' },
            { label: 'MetaApi', value: 'metaapi' },
          ],
          required: false,
        },
      ),
      credential(
        'mt_bridge_base_url',
        'Bridge Base URL (optional)',
        'http://bridge-node:9000',
        'Optional per-workspace bridge URL. If empty, backend global MT_BRIDGE_BASE_URL is used.',
      ...
      credential(
        ...
        'Bridge API key',
        'Optional per-workspace bridge API key.',
        { type: 'password', required: false, fullWidth: true },
      ),
      credential(
        'mt_terminal_path',
        'Terminal Path (optional)',
        'C:\\Program Files\\Broker MT4\\terminal.exe',
        'Optional explicit MT4 terminal executable path on your Windows bridge node.',
        { required: false, fullWidth: true },
      ),
      credential(
        'mt_data_path',
        ...
        'Optional MT data folder used by the bridge node terminal.',
        { required: false, fullWidth: true },
      ),
      credential(
        'mt_bridge_timeout_seconds',
        'Bridge Timeout Sec (optional)',
        '90',
        'Optional request timeout for bridge operations.',
  ...
  mt5: {
    ...
    credentials: [
      ...
      credential(
        'mt_terminal_path',
        'Terminal Path (optional)',
        'C:\\Program Files\\Broker MT5\\terminal64.exe',
        'Optional explicit MT5 terminal executable path on your Windows bridge node.',
        { required: false, fullWidth: true },
      ),
      credential(
        'mt_data_path',
